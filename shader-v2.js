/* ============================================================
   KASHI AI — "Fluxo Neural" cinematic WebGL background (v2 hero video)
   Living aurora / data-flow field. Mouse-reactive, generative.
   ============================================================ */
(function () {
  ...
  const frag = `
    ...
    void main(){
      ...
      // ribbon bands
      float band = sin((p.y*2.4 + f*2.8 + t*3.4)) * 0.5 + 0.5;
      band = pow(band, 1.9);

      // palette: purple -> indigo -> blue -> cyan
      vec3 cPurple = vec3(0.545, 0.361, 0.965);
      ...
      col *= glow * (1.05 + 0.55*u_intensity);

      // base dark tint
      vec3 base = vec3(0.020, 0.031, 0.086);
